...
{
    gic_data.base->D_ISENABLER[((u32)(s32)hwirq) >> 5] = (u32)(1UL << (((u32)(s32)hwirq) & 0x1FUL));
}

static void armv7_gic_disable(struct irq_chip *self, int hwirq)
{
    gic_data.base->D_ICENABLER[((u32)(s32)hwirq) >> 5] = (u32)(1UL << (((u32)(s32)hwirq) & 0x1FUL));
}
...
{
    gic_data.base->D_IPRIORITYR[((u32)(s32)hwirq)] = (u8)((priority << (8UL - __GIC_PRIO_BITS)) & (u32)0xFFUL);
}

static int armv7_gic_get_priority(struct irq_chip *self, int hwirq)
{
    return  (((u32)gic_data.base->D_IPRIORITYR[((u32)(s32)hwirq)] >> (8UL - __GIC_PRIO_BITS)));
}
