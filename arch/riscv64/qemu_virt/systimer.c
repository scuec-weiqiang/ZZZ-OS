 ...
 * @LastEditTime: 2025-05-08 01:03:24
...
enum SYS_CONFIG_HZ systimer_hz[MAX_HARTS_NUM] = {SYS_HZ_100,SYS_HZ_100};
...
void systimer_init(hart_id_t hart_id, enum SYS_CONFIG_HZ hz)
{
    ...
    systimer_ctx[hart_id][0] = (reg_t)clint_mtimecmp[hart_id];
    systimer_ctx[hart_id][1] = (reg_t)systimer_hz[hart_id];
