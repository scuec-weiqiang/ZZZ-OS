...
#ifndef __ASM_GENERIC_PGTBL_H
#define __ASM_GENERIC_PGTBL_H
...
phys_addr_t arch_pgtbl_entry_get_pa(pgtable_t *tbl, u32 level,pgdesc_type_t type, pte_t *entry); // pte 值转物理地址
u32 arch_pgtbl_level_index(pgtable_t *tbl, u32 level, virt_addr_t va);// 根据虚拟地址和级别计算页表索引
