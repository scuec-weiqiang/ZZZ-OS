...
extern int arch_pgtbl_init(pgtable_t *pgtbl);
extern int arch_map(pgtable_t *pgd, virt_addr_t va, phys_addr_t pa, enum huge_page huge_page, uint32_t flags);
extern int arch_unmap(pgtable_t *pgd, virt_addr_t va);
extern void arch_pgtbl_flush();
extern phys_addr_t arch_pgtbl_walk(pgtable_t *pgd, virt_addr_t va);
extern void arch_pgtbl_switch(pgtable_t *pgd);
